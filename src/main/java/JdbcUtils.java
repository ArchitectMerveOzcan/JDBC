...
public class JdbcUtils {
    ...
    //CREATE TABLE workers(worker_id VARCHAR(50), worker_name VARCHAR(20), worker_salary INT)
    ...
    //The method to insert to data into table
    public static void insertDataIntoTable(String tableName, String...columnName_Value){
        ...
        // "INSERT INTO "+tableName+"(id, name, adress) VALUES(123, John, new york)"
